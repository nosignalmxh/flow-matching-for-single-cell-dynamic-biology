...
resolve_project_root = partial(_resolve_project_root, markers=("src/experiments/timecourse.py",))
...
def write_section51_artifacts(
    ...
    for artifact in [metrics_path, summary_path, diag_path, diag_summary_path, main_text_path]:
...
def audit_section51_main_text_results(audit: pd.DataFrame, notebook_source: str | None = None) -> None:
    ...
    assert audit.shape == (25, 12), audit.shape
