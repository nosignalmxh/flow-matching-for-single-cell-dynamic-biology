...
from .metrics import mmd_rbf, sliced_wasserstein_distance, distribution_readout_metrics
...
def build_ch05_section51_main_text_results(
    ...
    velocity_jump_summary = {
        ...
        "shared_skip_uniform_t1": rounded_diag("shared_skip_uniform_6000", "t1"),
        "shared_skip_uniform_t3": rounded_diag("shared_skip_uniform_6000", "t3"),
        "shared_skip_uniform_mean_t1_t3": rounded_mean("shared_skip_uniform_6000"),
        "interpretation": (
