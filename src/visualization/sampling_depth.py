...
from ..evaluation.metrics import mmd_rbf, sliced_w2
from ..core.ot import compute_cost_matrix, coupling_diagnostics, sample_from_plan, sinkhorn_plan
...
def load_eb_data(*args, **kwargs) -> dict:
    from ..data.loading import load_eb_data as _load_eb_data

    return _load_eb_data(*args, **kwargs)
